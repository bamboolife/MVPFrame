...
import com.sundy.map.smooth.PointsUtil;
import com.sundy.map.smooth.SmoothMarker;
...
public class SmoothActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sy_smooth_layout);
    ...
    private View getInfoWindowView(Marker marker) {
        if (infoWindowLayout == null) {
            infoWindowLayout = new LinearLayout(getApplicationContext());
