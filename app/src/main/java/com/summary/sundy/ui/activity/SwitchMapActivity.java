...
public class SwitchMapActivity extends AppCompatActivity  implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sy_switch_map_layout);
        init();
        initLocation();
    ...
    public void onLocationChanged(AMapLocation aMapLocation) {
        if (aMapLocation != null
            ...
            Toast.makeText(SwitchMapActivity.this,aMapLocation.getCountry(),Toast.LENGTH_LONG).show();
            mIsAuto = false;
            mcheckbtn.setChecked(false);
        } else {
            String errText = "定位失败," + aMapLocation.getErrorCode() + ": " + aMapLocation.getErrorInfo();
            Log.e("AmapErr", errText);
            Toast.makeText(SwitchMapActivity.this, errText, Toast.LENGTH_LONG).show();
        }
    }
