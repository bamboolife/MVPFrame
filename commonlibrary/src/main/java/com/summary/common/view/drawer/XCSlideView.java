package com.summary.common.view.drawer;
...
public class XCSlideView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        mScreenWidth = DensityUtils.getScreenWidthAndHeight(context)[0];
    ...
    public void setMenuView(Activity activity, View view) {
        ...
        if( titleFrameLayout != null){
            layoutParams.topMargin = DensityUtils.getStatusBarHeight(mContext);
        }
