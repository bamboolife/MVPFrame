...
public class UIXEditText extends AppCompatEditText {
    ...
    public UIXEditText(Context context) {
        this(context, null);
    }

    public UIXEditText(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle); // Attention here !
    }

    public UIXEditText(Context context, AttributeSet attrs, int defStyleAttr) {
