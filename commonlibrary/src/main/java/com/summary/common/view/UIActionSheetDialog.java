...
public class UIActionSheetDialog {
    ...
    public UIActionSheetDialog setCancelable(boolean cancel) {
        dialog.setCancelable(cancel);
        return this;
    }

    public UIActionSheetDialog setCanceledOnTouchOutside(boolean cancel) {
     ...
     * @return
     */
    public UIActionSheetDialog addSheetItem(String strItem, SheetItemColor color,
