...
public class RecordedButton2 extends View {
    ...
    public RecordedButton2(Context context) {
        super(context);
        init();
    }

    public RecordedButton2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RecordedButton2(Context context, AttributeSet attrs, int defStyleAttr) {
