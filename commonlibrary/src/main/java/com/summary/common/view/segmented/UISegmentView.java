package com.summary.common.view.segmented;
...
public class UISegmentView extends RelativeLayout {
    ...
    public UISegmentView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UISegmentView(Context context, AttributeSet attrs, int defStyleAttr) {
